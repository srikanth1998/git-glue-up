...
<<<<<<< HEAD
    // Load static status page located at project root
...
<<<<<<< HEAD
    // Prevent this window from appearing in screen captures on all platforms
    // (Windows/Mac support as of Electron 12+)
